...
<html>
	...
	<body>
		...
		<div class="w3-main" style="margin-left:200px">
			...
			$result = $conn->query("SELECT * FROM Chicken WHERE chickenID = $chickenID;");
			...
			<form method="POST" action="chicken.php" enctype="multipart/form-data">
				<div class="row">
					<div class="w3-container w3-cell">
						<select id="maker" name="maker" autocomplete="off" required>
							<option disabled>화료자</option>
							<?php
							foreach ($names as $name) {
								if ($name === $rowitem['maker']) {
				...
				<div class="row">
					<div class="w3-container w3-cell w3-mobile">
						<input name="type" class="w3-input" type="text" placeholder="<?=$rowitem['type']?>" list="type_list" required autocomplete="off">
				...
				<div class="row">
					<div class="w3-container w3-cell">
						...
						<select id="loser" name="loser" autocomplete="off">
